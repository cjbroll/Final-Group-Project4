# NOTE: this is the create_lmdb_tuorial.py file from amir-jafari on Github
...
# 4. Put the size you want your images resize to (we tried 32 by 32, but the results were not good)
IMAGE_WIDTH = 32
IMAGE_HEIGHT = 32
